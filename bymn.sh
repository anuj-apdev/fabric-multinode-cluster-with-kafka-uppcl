...
export ORDERER_HOSTNAME="81-202.uppcl.com"
export ORG1_HOSTNAME="81-210.uppcl.com"
export ORG2_HOSTNAME="81-231.uppcl.com"
export SWARM_NETWORK="fabric"
export DOCKER_STACK="fabric"
export KAFKA0_HOSTNAME="81-202.uppcl.com"
export KAFKA1_HOSTNAME="81-210.uppcl.com"
export KAFKA2_HOSTNAME="81-231.uppcl.com"
export KAFKA3_HOSTNAME="81-202.uppcl.com"
export ZK0_HOSTNAME="81-202.uppcl.com"
export ZK1_HOSTNAME="81-210.uppcl.com"
export ZK2_HOSTNAME="81-231.uppcl.com"
...
function replacePrivateKey() {
  ...
  cd crypto-config/peerOrganizations/uppclorg1.uppcl.com/ca/
  PRIV_KEY=$(ls *_sk)
  cd "$CURRENT_DIR"
  if [ "${IF_COUCHDB}" == "couchdb" ]; then
  ...
  cd crypto-config/peerOrganizations/paytm.uppcl.com/ca/
  PRIV_KEY=$(ls *_sk)
  cd "$CURRENT_DIR"
  if [ "${IF_COUCHDB}" == "couchdb" ]; then
